...
const USER_PROMPT = `Analyze user support request. Translate to English if necessary. Output how you understand the support request as a list of 1-sentence questions that user is asking. Return the list as valid JSON array.
